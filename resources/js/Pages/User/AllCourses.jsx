      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-6 py-8">
          <div className="flex flex-col md:flex-row gap-6">
            {/* Sidebar Filters - Shows on desktop, toggles on mobile */}
              ...
              <div className="mb-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm text-gray-600">Rp. 500.000</span>
                  </div>
                  <input
                    type="range"
                    min="0"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {courses.data.map(course => (
                    <div key={course.id} className="bg-white rounded-lg shadow-sm overflow-hidden">
                      <img src={`/storage/${course.thumbnail}`} alt={course.title} className="w-full h-40 object-cover" />
                      <div className="p-4">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <p className="font-bold text-gray-800">Rp {course.price.toLocaleString()}</p>
                        </div>
                    ...
                    <div key={course.id} className="bg-white rounded-lg shadow-sm overflow-hidden">
                      <div className="flex flex-col md:flex-row">
                        ...
                        <div className="p-4 md:w-2/3 lg:w-3/4">
                          ...
                          <div className="flex flex-wrap items-center text-sm mb-3 gap-x-4 gap-y-2">
                            ...
                            <div className="flex items-center text-gray-500">
                              <BookOpen className="w-4 h-4" />
                              <span className="ml-1">{course.students.toLocaleString()} siswa</span>
                            </div>
                            <div className="flex items-center text-gray-500">
                              <Clock className="w-4 h-4" />
                              <span className="ml-1">{course.hours} jam</span>
                          ...
                          <div className="flex items-center justify-between mt-4">
                            <p className="font-bold text-gray-800">Rp {course.price.toLocaleString()}</p>
                            <Link href={route('allCourse.detail', {slug: course.slug, id: course.id})} className="bg-teal-500 hover:bg-teal-600 text-white px-6 py-2 rounded-md text-sm font-medium">Daftar Sekarang</Link>
                          </div>
                        </div>
                      </div>
                    </div>
