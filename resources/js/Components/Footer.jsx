      ...
      <div className="flex flex-wrap justify-between gap-10">
        ...
        <div className="max-lg:min-w-[140px]">
          ...
          <ul className="mt-6 space-y-4">
            ...
            <li>
              <a href="javascript:void(0)" className="hover:text-slate-900 text-slate-600 text-sm font-normal">Course</a>
            </li>
            <li>
              <a href="javascript:void(0)" className="hover:text-slate-900 text-slate-600 text-sm font-normal">About</a>
            </li>
            <li>
              <a href="javascript:void(0)" className="hover:text-slate-900 text-slate-600 text-sm font-normal">Services</a>
            </li>
            <li>
